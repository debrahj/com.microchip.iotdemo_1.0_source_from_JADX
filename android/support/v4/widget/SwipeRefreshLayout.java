...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    class C00561 extends Animation {
        C00561() {
        }
    ...
    class C00572 extends Animation {
        C00572() {
        }
    ...
    class C00585 implements Runnable {
        C00585() {
        }
    ...
    class C00883 extends BaseAnimationListener {
        C00883() {
            super();
        }
    ...
    class C00894 extends BaseAnimationListener {
        C00894() {
            super();
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mAnimateToStartPosition = new C00561();
        this.mShrinkTrigger = new C00572();
        this.mReturnToStartPositionListener = new C00883();
        this.mShrinkAnimationListener = new C00894();
        this.mReturnToStartPosition = new C00585();
        this.mCancel = new C00596();
